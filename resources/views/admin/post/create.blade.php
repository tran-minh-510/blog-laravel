            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('post.create.post') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-12">
                                    <div class="row">
                                ...
                                <div class="col-12 mt-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <textarea class="form-control" id="summary" required rows="3" name="summary"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 mt-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <textarea class="form-control" id="content"  value="{{ old('content') }}" required rows="3" name="content"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-0">
                                ...
                                <div class="col-6 mt-2 offset-md-4">
                                    <a class="btn btn-warning" href="{{ route('admin') }}"
                                        role="button">{{ __('Quay lại trang chủ') }}</a>
                                </div>
                            </div>
